...
function switchLiveUpdaates(){
  isLiveUpdatesOn = !isLiveUpdatesOn;
  alert(isLiveUpdatesOn);
  if(isLiveUpdatesOn){
    document.getElementById("liveUpdates").text = "Live Updates On";
    document.getElementById("liveUpdates").style.backgroundColor = "green";
    document.getElementById("liveUpdates").style.color = "white";
  }
}
